...
<span class="option-feedback hidden"><p>Consider the instance <span class="katex-inline">$(x,y_1,z_1), \ldots, (x,y_n,z_n)$</span> where the <span class="katex-inline">$y$</span>s and <span class="katex-inline">$z$</span>s are all distinct. What if greedy never picks <span class="katex-inline">$x$</span>?</p></span>
</span>
</label>
...
<span class="option-text"><p>The approximation could be as bad as <span class="katex-inline">$n - 2$</span>.</p>
</span>
</label>
</div>
...
<strong>Solution:</strong> <p>Correct option: Indeed, the approximation could be as bad as <span class="katex-inline">$n - 2$</span>.</p>
</div>
</div>
