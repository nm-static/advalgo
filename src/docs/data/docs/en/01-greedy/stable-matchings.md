...
description: "3. Stable Matchings - Advanced Algorithms"
section: main
sidebar:
  order: 3
  label: "3. Stable Matchings"
---
...
<div class="callout-title">Blocking Pair</div>
...
<div class="callout callout-note">
<div class="callout-title">Unstable Matching</div>
<div class="callout-body">
...
<div class="callout callout-note">
<div class="callout-title">An Example of a Matching with <em>no</em> blocking pairs.</div>
<div class="callout-body">
...
<div class="callout callout-note">
<div class="callout-title">How many blocking pairs can we have?</div>
<div class="callout-body">
...
<div class="callout callout-note">
<div class="callout-title">Stable Matching</div>
<div class="callout-body">
...
<div class="callout callout-note">
<div class="callout-title">Verifying that a matching is stable.</div>
<div class="callout-body">
...
Anticipating our need for stability, we take a greedy approach: the men attempt to match up to their best option by _proposing_ to them. But notice that this may not be immediately workable: possibly multiple men have the same choice for their top option. This puts the ball in the woman's court, so to speak, and again in the interest of being eventually stable, it's intuitive that the woman will choose to align with the best offer she has among the proposals she's received.

Also, since we finally want everyone to be matched, we will also ensure that proposals are not rejected simply because they seem unattractive in absolute terms: if a woman who's single receives one or more proposals, she will accept the best among them, no matter how good or bad they are.

After one round of proposals, the situation is as follows:

- some women (say $W_\star \subseteq W$) received one or more proposals and picked the best offer, and are no longer single;
- some women (say $W_0 = W \setminus W_\star$) received no proposals and are still single;
...
If $W_0 = \emptyset$, that's awesome, because what that means is all men had distinct choices for their top preference, and so $V_0 = \emptyset$ as well and we already have a matching where everyone has their best possible match: so this is clearly very stable and we are done.
...
The first property follows from the fact that men never propose twice to the same woman, so the number of proposals made is $\leqslant n^2$. Also note that no man $m$ is rejected by _all_ women: this can only happen if all the women have found better engagements (which are necessarily distinct --- notice that the set of engagements at any stage of the algorithm always forms a valid matching), but there are only $n-1$ men other than $w$: so this is not feasible.
...
<summary class="callout-title">Finding a stable matching</summary>
<div class="callout-body">
...
<details class="callout callout-tip">
<summary class="callout-title">The Men Are Lucky</summary>
<div class="callout-body">
...
<details class="callout callout-tip">
<summary class="callout-title">The GS matching is weakly PO</summary>
<div class="callout-body">
